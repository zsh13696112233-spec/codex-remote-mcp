...
interface RoleRepository extends JpaRepository<RoleEntity, String> {
  ...
  List<RoleEntity> findByDeletedFalseAndGroupIdAndNameContainingIgnoreCaseOrderByCreatedAtDesc(
  ...
  boolean existsByDeletedFalseAndNameIgnoreCaseAndIdNot(String name, String id);
}
